...
* remove folder theme/mboost/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/mboost/scss/bootstrap
...
* comment out this line in theme/mboost/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/mboost/amd/src/bootstrap (including the subfolder)
...
* in folder theme/mboost run "Grunt amd" to compile the bootstrap JS
