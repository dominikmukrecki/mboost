...
/**
 * This file contains the unittests for mboost's scss compilation.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_mboost_scss_testcase extends advanced_testcase {
    /**
     * Test that mboost can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('mboost')->get_css_content_debug('scss', null, null)
        );
    }
}
