...
/**
 * Privacy tests for theme_mboost.
 *
...
use \theme_mboost\privacy\provider;

/**
 * Unit tests for theme_mboost/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_mboost_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_mboost');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_mboost'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_mboost'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
